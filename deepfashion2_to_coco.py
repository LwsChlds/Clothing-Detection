...
def json2coco(num_images, source, output):

    sub_index = 0 # the index of ground truth instance
    for num in range(1,num_images+1):
        json_name = source + '/annos/' + str(num).zfill(6)+'.json'
        image_name = source + '/image/' + str(num).zfill(6)+'.jpg'
...
if __name__ == '__main__':
    print ("Converting " +  str(len(os.listdir("Original-Data/train/annos"))) + " training data files into a coco json..." )
    json2coco(len(os.listdir("Original-Data/train/annos")), "Original-Data/train", "trainDeepfashion2.json")
    print ("Converting " +  str(len(os.listdir("Original-Data/validation/annos"))) + " validation data files into a coco json..." )
    json2coco(len(os.listdir("Original-Data/validation/annos")), "Original-Data/validation", "validationDeepfashion2.json")
